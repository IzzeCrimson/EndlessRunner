...
// End Cross Module References
	...
	struct Z_Construct_UClass_APlatformSpawner_Statics
	{
		...
		static const UECodeGen_Private::FClassPropertyParams NewProp_TemplatePlatforms_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TemplatePlatforms_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_TemplatePlatforms;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_APlatformSpawner_Statics::NewProp_TemplatePlatforms_Inner = { "TemplatePlatforms", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_UClass, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APlatformSpawner_Statics::NewProp_TemplatePlatforms_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Platform Components" },
		{ "ModuleRelativePath", "Public/PlatformSpawner.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_APlatformSpawner_Statics::NewProp_TemplatePlatforms = { "TemplatePlatforms", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(APlatformSpawner, TemplatePlatforms), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_APlatformSpawner_Statics::NewProp_TemplatePlatforms_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APlatformSpawner_Statics::NewProp_TemplatePlatforms_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APlatformSpawner_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlatformSpawner_Statics::NewProp_TemplatePlatforms_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlatformSpawner_Statics::NewProp_TemplatePlatforms,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_william_isacsson_Unreal_Projects_EndlessRunner_EndlessRunner_Source_EndlessRunner_Public_PlatformSpawner_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APlatformSpawner, APlatformSpawner::StaticClass, TEXT("APlatformSpawner"), &Z_Registration_Info_UClass_APlatformSpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APlatformSpawner), 3442972994U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_william_isacsson_Unreal_Projects_EndlessRunner_EndlessRunner_Source_EndlessRunner_Public_PlatformSpawner_h_1749456566(TEXT("/Script/EndlessRunner"),
